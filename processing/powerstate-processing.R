...
# Example
df <- powerstate_preprocess(mypath = "/Users/user/beiwe-data/8qpsyamw/power_state", beiweID = "8qpsyamw")
View(df)
...
power_df <- get_power_state_all(parent_dir = "parent_directory", id_position = 8)
